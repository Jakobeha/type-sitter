...
*/
    ...
    > + 'a {
        ::type_sitter_lib::Node::raw(self)
            ...
            .map(
                <anon_unions::Anon69184434770287439701619402063275806352<
                    'tree,
                > as ::type_sitter_lib::Node<'tree>>::try_from_raw,
            )
    }
...
- [`UnionPattern`]*/
    ...
    for Anon19138044972977955760340976501314106174<'tree> {
...
- [`UnionPattern`]*/
    ...
    #[automatically_derived]
    impl<'tree> ::type_sitter_lib::Node<'tree>
    for Anon229485655885293351611142396350571839217<'tree> {
...
- [`UnionPattern`]*/
    ...
    #[automatically_derived]
    impl<'tree> ::type_sitter_lib::Node<'tree>
    for Anon34817075775227833758609982580855775002<'tree> {
...
- [`UnionPattern`]*/
    ...
    #[automatically_derived]
    impl<'tree> ::type_sitter_lib::Node<'tree>
    for Anon69184434770287439701619402063275806352<'tree> {
