...
- [`unnamed::Yield`]*/
    ...
    impl<'tree> ::type_sitter_lib::Node<'tree> for Keyword<'tree> {
        ...
        fn try_from_raw(
            ...
            if let Ok(this) = <unnamed::Def<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::Def(this));
            }
            if let Ok(this) = <unnamed::Del<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::Del(this));
            }
            if let Ok(this) = <unnamed::Elif<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
            ...
            if let Ok(this) = <unnamed::Except<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::Except(this));
            }
            if let Ok(this) = <unnamed::Exec<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::Exec(this));
            }
            if let Ok(this) = <unnamed::Finally<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
            ...
            if let Ok(this) = <unnamed::From<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::From(this));
            }
            if let Ok(this) = <unnamed::Global<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
            ...
            if let Ok(this) = <unnamed::Import<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::Import(this));
            }
            if let Ok(this) = <unnamed::Lambda<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
            ...
            if let Ok(this) = <unnamed::Nonlocal<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::Nonlocal(this));
            }
            if let Ok(this) = <unnamed::Pass<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::Pass(this));
            }
            if let Ok(this) = <unnamed::Print<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::Print(this));
            }
            if let Ok(this) = <unnamed::Raise<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
...
- [`symbols::BitNot`]*/
    ...
    impl<'tree> ::type_sitter_lib::Node<'tree> for Operator<'tree> {
        ...
        fn try_from_raw(
            ...
            if let Ok(this) = <symbols::ColonEq<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
