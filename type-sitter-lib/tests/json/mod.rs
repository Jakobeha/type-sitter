...
impl<'tree> Array<'tree> {
    ...
    pub fn children<'a>(
        ...
        self.0.children(c).map(<Value<'tree> as TryFrom<_>>::try_from)
    }
    ...
    pub fn child(
        &self,
        i: usize,
    ) -> Option<type_sitter_lib::NodeResult<'tree, Value<'tree>>> {
...
impl<'tree> Object<'tree> {
    ...
    pub fn children<'a>(
        ...
        self.0.children(c).map(<Pair<'tree> as TryFrom<_>>::try_from)
    }
    ///Get the node's child #i
    #[allow(dead_code)]
    #[inline]
    pub fn child(
        &self,
        i: usize,
    ) -> Option<type_sitter_lib::NodeResult<'tree, Pair<'tree>>> {
...
impl<'tree> Pair<'tree> {
    ...
    pub fn key(
        ...
        'tree,
        type_sitter_lib::either_n::Either2<Number<'tree>, String<'tree>>,
    > {
        self.0
...
impl<'tree> String<'tree> {
    ...
    pub fn child(
        ...
        self.0.child(0).map(<StringContent<'tree> as TryFrom<_>>::try_from)
    }
}
