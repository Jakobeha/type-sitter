...
This child has type `outer_doc_comment_marker?` ([`OuterDocCommentMarker`])*/
    ...
    impl<'tree> ::type_sitter_lib::Node<'tree> for Comment<'tree> {
        ...
        fn try_from_raw(
            ...
            if let Ok(this) = <BlockComment<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::BlockComment(this));
            }
            if let Ok(this) = <LineComment<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
...
- [`unnamed::Yield`]*/
    ...
    impl<'tree> ::type_sitter_lib::Node<'tree> for Keyword<'tree> {
        ...
        fn try_from_raw(
            ...
            if let Ok(this) = <unnamed::As<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::As(this));
            }
            if let Ok(this) = <unnamed::Async<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::Async(this));
            }
            if let Ok(this) = <unnamed::Await<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
            ...
            if let Ok(this) = <unnamed::Let<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::Let(this));
            }
            if let Ok(this) = <unnamed::Loop<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::Loop(this));
            }
            if let Ok(this) = <symbols::MacroRulesNot<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::MacroRulesNot(this));
            }
            if let Ok(this) = <unnamed::Match<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::Match(this));
            }
            if let Ok(this) = <unnamed::Mod<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::Mod(this));
            }
            if let Ok(this) = <unnamed::Move<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
            ...
            if let Ok(this) = <unnamed::Pub<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::Pub(this));
            }
            if let Ok(this) = <unnamed::Raw<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::Raw(this));
            }
            if let Ok(this) = <unnamed::Ref<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
            ...
            if let Ok(this) = <unnamed::Trait<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::Trait(this));
            }
            if let Ok(this) = <unnamed::Type<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
            ...
            if let Ok(this) = <unnamed::Unsafe<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::Unsafe(this));
            }
            if let Ok(this) = <unnamed::Use<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::Use(this));
            }
            if let Ok(this) = <unnamed::Where<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
...
- [`symbols::RBrace`]*/
    ...
    impl<'tree> ::type_sitter_lib::Node<'tree> for PunctuationBracket<'tree> {
        ...
        fn try_from_raw(
            ...
            if let Ok(this) = <symbols::LParen<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::LParen(this));
            }
            if let Ok(this) = <symbols::RParen<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
            ...
            if let Ok(this) = <symbols::LBracket<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::LBracket(this));
            }
            if let Ok(this) = <symbols::RBracket<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::RBracket(this));
            }
            if let Ok(this) = <symbols::LBrace<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::LBrace(this));
            }
            if let Ok(this) = <symbols::RBrace<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
...
- [`symbols::Semicolon`]*/
    ...
    impl<'tree> ::type_sitter_lib::Node<'tree> for PunctuationDelimiter<'tree> {
        ...
        fn try_from_raw(
            ...
            if let Ok(this) = <symbols::Colon<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::Colon(this));
            }
            if let Ok(this) = <symbols::ColonColon<
                'tree,
            > as ::type_sitter_lib::Node<'tree>>::try_from_raw(node) {
