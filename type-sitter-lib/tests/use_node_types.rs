...
use std::path::Path;
use type_sitter_lib::{HasChildren, Node, Parser};
...
pub fn test_use_node_types_rust() {
    ...
    let statements = code_root
        .children(&mut code_root.walk())
    ...
    assert!(
        statements[0]
            ...
            .as_use_declaration()
            .is_some(),
        "Expected 1st statement to be a use declaration"
    );
    assert!(
        statements[1]
            .as_declaration_statement()
            ...
            .as_foreign_mod_item()
            .is_some(),
        "Expected 2nd statement to be a foreign mod item"
    );
    assert!(
        statements[2]
            .as_declaration_statement()
            ...
            .as_const_item()
            .is_some(),
        "Expected 3rd statement to be a const item"
    );
    assert!(
        statements[3]
            .as_declaration_statement()
            ...
            .as_const_item()
            .is_some(),
        "Expected 4th statement to be a const item"
    );
    assert!(
        statements[4]
            .as_declaration_statement()
            ...
            .as_const_item()
            .is_some(),
        "Expected 5th statement to be a const item"
    );
    assert!(
        statements[5]
            .as_declaration_statement()
            ...
            .as_const_item()
            .is_some(),
        "Expected 6th statement to be a const item"
    );
    assert!(
        statements[6]
            .as_declaration_statement()
            ...
            .as_const_item()
            .is_some(),
        "Expected 7th statement to be a const item"
    );
    assert!(
        statements[7]
            .as_declaration_statement()
            ...
            .as_attribute_item()
            .is_some(),
        "Expected 8th statement to be an attribute item"
    );
    assert!(
        statements[8]
            .as_declaration_statement()
            ...
            .as_mod_item()
            .is_some(),
        "Expected 9th statement to be a mod item"
    );
    assert_eq!(
        statements[0]
            .as_declaration_statement()
            .expect("Expected declaration statement")
            .as_use_declaration()
            .expect("Expected use declaration")
            .argument()
            .unwrap()
            .as_scoped_identifier()
            .expect("Expected use declaration to have a scoped identifier")
            .path()
            .expect("Expected use declaration's scoped identifier to have a path")
            .unwrap()
            .as_identifier()
            .expect("Expected use declaration's scope identifier to have an identifier")
            .text(),
