...
pub enum HighlightsCapture<'tree> {
    #[doc = "A `variable` ([`super::nodes::Identifier`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(identifier) @variable"]
    #[doc = "```"]
    Variable(super::nodes::Identifier<'tree>),
    #[doc = "A `constructor` ([`super::nodes::Identifier`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    ...
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(decorator) @function"]
    #[doc = "(identifier) @function"]
    #[doc = "(identifier) @function"]
    #[doc = "(identifier) @function"]
    #[doc = "```"]
    Function(anon_unions::Function<'tree>),
    #[doc = "A `function.method` ([`super::nodes::Identifier`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(identifier) @function.method"]
    #[doc = "```"]
    FunctionMethod(super::nodes::Identifier<'tree>),
    #[doc = "A `function.builtin` ([`super::nodes::Identifier`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(identifier) @function.builtin"]
    #[doc = "```"]
    FunctionBuiltin(super::nodes::Identifier<'tree>),
    #[doc = "A `property` ([`super::nodes::Identifier`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(identifier) @property"]
    #[doc = "```"]
    Property(super::nodes::Identifier<'tree>),
    #[doc = "A `type` ([`super::nodes::Identifier`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(identifier) @type"]
    ...
    #[doc = "A `number` ([`anon_unions::Number`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "[\n  (integer)\n  (float)\n] @number"]
    ...
    #[doc = "A `embedded` ([`super::nodes::Interpolation`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(interpolation\n  \"{\" @punctuation.special\n  \"}\" @punctuation.special) @embedded"]
...
impl ::type_sitter::Query for Highlights {
    ...
    fn raw(&self) -> &'static ::type_sitter::raw::Query {
        ...
        __Highlights__ . get_or_init (|| { # [allow (unused_mut)] let mut query = :: type_sitter :: raw :: Query :: new (& tree_sitter_python :: LANGUAGE . into () , "; Identifier naming conventions\n\n(identifier) @variable\n\n((identifier) @constructor\n (#match? @constructor \"^[A-Z]\"))\n\n((identifier) @constant\n (#match? @constant \"^[A-Z][A-Z_]*$\"))\n\n; Function calls\n\n(decorator) @function\n(decorator\n  (identifier) @function)\n\n(call\n  function: (attribute attribute: (identifier) @function.method))\n(call\n  function: (identifier) @function)\n\n; Builtin functions\n\n((call\n  function: (identifier) @function.builtin)\n (#match?\n   @function.builtin\n   \"^(abs|all|any|ascii|bin|bool|breakpoint|bytearray|bytes|callable|chr|classmethod|compile|complex|delattr|dict|dir|divmod|enumerate|eval|exec|filter|float|format|frozenset|getattr|globals|hasattr|hash|help|hex|id|input|int|isinstance|issubclass|iter|len|list|locals|map|max|memoryview|min|next|object|oct|open|ord|pow|print|property|range|repr|reversed|round|set|setattr|slice|sorted|staticmethod|str|sum|super|tuple|type|vars|zip|__import__)$\"))\n\n; Function definitions\n\n(function_definition\n  name: (identifier) @function)\n\n(attribute attribute: (identifier) @property)\n(type (identifier) @type)\n\n; Literals\n\n[\n  (none)\n  (true)\n  (false)\n] @constant.builtin\n\n[\n  (integer)\n  (float)\n] @number\n\n(comment) @comment\n(string) @string\n(escape_sequence) @escape\n\n(interpolation\n  \"{\" @punctuation.special\n  \"}\" @punctuation.special) @embedded\n\n[\n  \"-\"\n  \"-=\"\n  \"!=\"\n  \"*\"\n  \"**\"\n  \"**=\"\n  \"*=\"\n  \"/\"\n  \"//\"\n  \"//=\"\n  \"/=\"\n  \"&\"\n  \"&=\"\n  \"%\"\n  \"%=\"\n  \"^\"\n  \"^=\"\n  \"+\"\n  \"->\"\n  \"+=\"\n  \"<\"\n  \"<<\"\n  \"<<=\"\n  \"<=\"\n  \"<>\"\n  \"=\"\n  \":=\"\n  \"==\"\n  \">\"\n  \">=\"\n  \">>\"\n  \">>=\"\n  \"|\"\n  \"|=\"\n  \"~\"\n  \"@=\"\n  \"and\"\n  \"in\"\n  \"is\"\n  \"not\"\n  \"or\"\n  \"is not\"\n  \"not in\"\n] @operator\n\n[\n  \"as\"\n  \"assert\"\n  \"async\"\n  \"await\"\n  \"break\"\n  \"class\"\n  \"continue\"\n  \"def\"\n  \"del\"\n  \"elif\"\n  \"else\"\n  \"except\"\n  \"exec\"\n  \"finally\"\n  \"for\"\n  \"from\"\n  \"global\"\n  \"if\"\n  \"import\"\n  \"lambda\"\n  \"nonlocal\"\n  \"pass\"\n  \"print\"\n  \"raise\"\n  \"return\"\n  \"try\"\n  \"while\"\n  \"with\"\n  \"yield\"\n  \"match\"\n  \"case\"\n] @keyword\n") . expect ("query parsed at compile-time but failed at runtime. Is the language 'tree_sitter_python' correct, and did you use the same tree-sitter / tree_sitter_python version?") ; query })
    }
    #[inline]
    ...
    unsafe fn wrap_capture<'query, 'tree: 'query>(
        ...
        match capture . index as usize { 0usize => HighlightsCapture :: Variable (< super :: nodes :: Identifier < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , 1usize => HighlightsCapture :: Constructor (< super :: nodes :: Identifier < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , 2usize => HighlightsCapture :: Constant (< super :: nodes :: Identifier < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , 3usize => HighlightsCapture :: Function (< anon_unions :: Function < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , 4usize => HighlightsCapture :: FunctionMethod (< super :: nodes :: Identifier < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , 5usize => HighlightsCapture :: FunctionBuiltin (< super :: nodes :: Identifier < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , 6usize => HighlightsCapture :: Property (< super :: nodes :: Identifier < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , 7usize => HighlightsCapture :: Type (< super :: nodes :: Identifier < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , 8usize => HighlightsCapture :: ConstantBuiltin (< anon_unions :: ConstantBuiltin < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , 9usize => HighlightsCapture :: Number (< anon_unions :: Number < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , 10usize => HighlightsCapture :: Comment (< super :: nodes :: Comment < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , 11usize => HighlightsCapture :: String (< super :: nodes :: String < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , 12usize => HighlightsCapture :: Escape (< super :: nodes :: EscapeSequence < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , 13usize => HighlightsCapture :: PunctuationSpecial (< anon_unions :: PunctuationSpecial < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , 14usize => HighlightsCapture :: Embedded (< super :: nodes :: Interpolation < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , 15usize => HighlightsCapture :: Operator (< anon_unions :: Operator < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , 16usize => HighlightsCapture :: Keyword (< anon_unions :: Keyword < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , capture_index => unreachable ! ("Invalid capture index: {}" , capture_index) }
    }
}
#[automatically_derived]
#[allow(unused)]
impl<'query, 'tree: 'query> HighlightsMatch<'query, 'tree> {
    #[doc = "Returns an iterator over the nodes captured by `variable` ([`super::nodes::Identifier`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(identifier) @variable"]
    ...
    pub fn variable(&self) -> ::std::option::Option<super::nodes::Identifier<'tree>> {
        { [0u32] . into_iter () . flat_map (| i | self . 0 . nodes_for_capture_index (i)) . map (| n | unsafe { < super :: nodes :: Identifier < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (n) }) } . next ()
    }
    #[doc = "Returns an iterator over the nodes captured by `constructor` ([`super::nodes::Identifier`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(identifier) @constructor"]
    ...
    pub fn constructor(&self) -> ::std::option::Option<super::nodes::Identifier<'tree>> {
        { [1u32] . into_iter () . flat_map (| i | self . 0 . nodes_for_capture_index (i)) . map (| n | unsafe { < super :: nodes :: Identifier < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (n) }) } . next ()
    }
    ...
    pub fn constant(&self) -> ::std::option::Option<super::nodes::Identifier<'tree>> {
        { [2u32] . into_iter () . flat_map (| i | self . 0 . nodes_for_capture_index (i)) . map (| n | unsafe { < super :: nodes :: Identifier < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (n) }) } . next ()
    }
    ...
    pub fn function(&self) -> ::std::option::Option<anon_unions::Function<'tree>> {
        { [3u32] . into_iter () . flat_map (| i | self . 0 . nodes_for_capture_index (i)) . map (| n | unsafe { < anon_unions :: Function < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (n) }) } . next ()
    }
    #[doc = "Returns an iterator over the nodes captured by `function.method` ([`super::nodes::Identifier`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(identifier) @function.method"]
    #[doc = "```"]
    #[inline]
    pub fn function_method(&self) -> ::std::option::Option<super::nodes::Identifier<'tree>> {
        { [4u32] . into_iter () . flat_map (| i | self . 0 . nodes_for_capture_index (i)) . map (| n | unsafe { < super :: nodes :: Identifier < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (n) }) } . next ()
    }
    #[doc = "Returns an iterator over the nodes captured by `function.builtin` ([`super::nodes::Identifier`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(identifier) @function.builtin"]
    #[doc = "```"]
    #[inline]
    pub fn function_builtin(&self) -> ::std::option::Option<super::nodes::Identifier<'tree>> {
    ...
    #[doc = "Returns an iterator over the nodes captured by `property` ([`super::nodes::Identifier`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(identifier) @property"]
    ...
    pub fn property(&self) -> ::std::option::Option<super::nodes::Identifier<'tree>> {
        { [6u32] . into_iter () . flat_map (| i | self . 0 . nodes_for_capture_index (i)) . map (| n | unsafe { < super :: nodes :: Identifier < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (n) }) } . next ()
    }
    #[doc = "Returns an iterator over the nodes captured by `type` ([`super::nodes::Identifier`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(identifier) @type"]
    ...
    pub fn r#type(&self) -> ::std::option::Option<super::nodes::Identifier<'tree>> {
        { [7u32] . into_iter () . flat_map (| i | self . 0 . nodes_for_capture_index (i)) . map (| n | unsafe { < super :: nodes :: Identifier < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (n) }) } . next ()
    }
    ...
    pub fn constant_builtin(&self) -> ::std::option::Option<anon_unions::ConstantBuiltin<'tree>> {
        { [8u32] . into_iter () . flat_map (| i | self . 0 . nodes_for_capture_index (i)) . map (| n | unsafe { < anon_unions :: ConstantBuiltin < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (n) }) } . next ()
    }
    #[doc = "Returns an iterator over the nodes captured by `number` ([`anon_unions::Number`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "[\n  (integer)\n  (float)\n] @number"]
    ...
    pub fn number(&self) -> ::std::option::Option<anon_unions::Number<'tree>> {
        {
            [9u32]
                ...
                .map(|n| unsafe {
                    <anon_unions::Number<'tree> as ::type_sitter::Node<'tree>>::from_raw_unchecked(
                        n,
                    )
                })
        }
    ...
    pub fn comment(&self) -> ::std::option::Option<super::nodes::Comment<'tree>> {
        { [10u32] . into_iter () . flat_map (| i | self . 0 . nodes_for_capture_index (i)) . map (| n | unsafe { < super :: nodes :: Comment < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (n) }) } . next ()
    }
    ...
    pub fn escape(&self) -> ::std::option::Option<super::nodes::EscapeSequence<'tree>> {
        { [12u32] . into_iter () . flat_map (| i | self . 0 . nodes_for_capture_index (i)) . map (| n | unsafe { < super :: nodes :: EscapeSequence < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (n) }) } . next ()
    }
    ...
    pub fn punctuation_special(
        ...
        {
            [13u32] . into_iter () . flat_map (| i | self . 0 . nodes_for_capture_index (i)) . map (| n | unsafe { < anon_unions :: PunctuationSpecial < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (n) })
        }
    }
    #[doc = "Returns an iterator over the nodes captured by `embedded` ([`super::nodes::Interpolation`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(interpolation\n  \"{\" @punctuation.special\n  \"}\" @punctuation.special) @embedded"]
    ...
    pub fn embedded(&self) -> ::std::option::Option<super::nodes::Interpolation<'tree>> {
        { [14u32] . into_iter () . flat_map (| i | self . 0 . nodes_for_capture_index (i)) . map (| n | unsafe { < super :: nodes :: Interpolation < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (n) }) } . next ()
    }
    ...
    pub fn operator(&self) -> ::std::option::Option<anon_unions::Operator<'tree>> {
        { [15u32] . into_iter () . flat_map (| i | self . 0 . nodes_for_capture_index (i)) . map (| n | unsafe { < anon_unions :: Operator < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (n) }) } . next ()
    }
...
impl<'tree> HighlightsCapture<'tree> {
    #[doc = "Try to interpret this capture as a `variable` ([`super::nodes::Identifier`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(identifier) @variable"]
    #[doc = "```"]
    #[inline]
    pub fn as_variable(&self) -> ::std::option::Option<&super::nodes::Identifier<'tree>> {
        #[allow(irrefutable_let_patterns)]
        if let Self::Variable(node) = self {
            Some(node)
        } else {
            None
        }
    }
    #[doc = "Try to interpret this capture as a `constructor` ([`super::nodes::Identifier`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(identifier) @constructor"]
    #[doc = "```"]
    #[inline]
    pub fn as_constructor(&self) -> ::std::option::Option<&super::nodes::Identifier<'tree>> {
        #[allow(irrefutable_let_patterns)]
    ...
    #[doc = "Try to interpret this capture as a `function.method` ([`super::nodes::Identifier`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(identifier) @function.method"]
    #[doc = "```"]
    #[inline]
    pub fn as_function_method(&self) -> ::std::option::Option<&super::nodes::Identifier<'tree>> {
        #[allow(irrefutable_let_patterns)]
    ...
    #[doc = "Try to interpret this capture as a `function.builtin` ([`super::nodes::Identifier`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(identifier) @function.builtin"]
    #[doc = "```"]
    #[inline]
    pub fn as_function_builtin(&self) -> ::std::option::Option<&super::nodes::Identifier<'tree>> {
        #[allow(irrefutable_let_patterns)]
        if let Self::FunctionBuiltin(node) = self {
            Some(node)
        } else {
            None
        }
    }
    #[doc = "Try to interpret this capture as a `property` ([`super::nodes::Identifier`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(identifier) @property"]
    #[doc = "```"]
    #[inline]
    pub fn as_property(&self) -> ::std::option::Option<&super::nodes::Identifier<'tree>> {
        #[allow(irrefutable_let_patterns)]
    ...
    #[doc = "Try to interpret this capture as a `type` ([`super::nodes::Identifier`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(identifier) @type"]
    ...
    #[doc = "Try to interpret this capture as a `number` ([`anon_unions::Number`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "[\n  (integer)\n  (float)\n] @number"]
    ...
    pub fn as_punctuation_special(
        ...
        #[allow(irrefutable_let_patterns)]
        if let Self::PunctuationSpecial(node) = self {
            Some(node)
        } else {
            None
        }
    }
    #[doc = "Try to interpret this capture as a `embedded` ([`super::nodes::Interpolation`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(interpolation\n  \"{\" @punctuation.special\n  \"}\" @punctuation.special) @embedded"]
    #[doc = "```"]
    #[inline]
    pub fn as_embedded(&self) -> ::std::option::Option<&super::nodes::Interpolation<'tree>> {
        #[allow(irrefutable_let_patterns)]
        if let Self::Embedded(node) = self {
            Some(node)
        } else {
            None
        }
    ...
    for HighlightsCapture<'tree>
{
    ...
    fn raw(&self) -> ::type_sitter::raw::QueryCapture<'tree> {
        ...
        match self {
            Self::Variable(node) => ::type_sitter::raw::QueryCapture {
                index: 0usize as u32,
                node: *node.raw(),
            },
            ...
            Self::FunctionBuiltin(node) => ::type_sitter::raw::QueryCapture {
                index: 5usize as u32,
                node: *node.raw(),
            },
            ...
            Self::PunctuationSpecial(node) => ::type_sitter::raw::QueryCapture {
                index: 13usize as u32,
                node: *node.raw(),
            },
            Self::Embedded(node) => ::type_sitter::raw::QueryCapture {
    ...
    fn node(&self) -> &::type_sitter::UntypedNode<'tree> {
        ...
        use ::type_sitter::Node;
        match self {
            Self::Variable(node) => ::type_sitter::UntypedNode::r#ref(node.raw()),
            ...
            Self::FunctionBuiltin(node) => ::type_sitter::UntypedNode::r#ref(node.raw()),
            ...
            Self::PunctuationSpecial(node) => ::type_sitter::UntypedNode::r#ref(node.raw()),
            Self::Embedded(node) => ::type_sitter::UntypedNode::r#ref(node.raw()),
    ...
    fn node_mut(&mut self) -> &mut ::type_sitter::UntypedNode<'tree> {
        ...
        use ::type_sitter::Node;
        match self {
            Self::Variable(node) => ::type_sitter::UntypedNode::r#mut(node.raw_mut()),
            ...
            Self::FunctionBuiltin(node) => ::type_sitter::UntypedNode::r#mut(node.raw_mut()),
            ...
            Self::PunctuationSpecial(node) => ::type_sitter::UntypedNode::r#mut(node.raw_mut()),
            Self::Embedded(node) => ::type_sitter::UntypedNode::r#mut(node.raw_mut()),
...
pub enum TagsCapture<'tree> {
    ...
    #[doc = "A `definition.constant` ([`super::nodes::Assignment`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(assignment left: (identifier) @name) @definition.constant"]
    #[doc = "```"]
    DefinitionConstant(super::nodes::Assignment<'tree>),
    #[doc = "A `definition.class` ([`super::nodes::ClassDefinition`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    ...
    #[doc = "A `definition.function` ([`super::nodes::FunctionDefinition`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(function_definition\n  name: (identifier) @name) @definition.function"]
    #[doc = "```"]
    DefinitionFunction(super::nodes::FunctionDefinition<'tree>),
    #[doc = "A `reference.call` ([`super::nodes::Call`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(call\n  function: [\n      (identifier) @name\n      (attribute\n        attribute: (identifier) @name)\n  ]) @reference.call"]
...
impl ::type_sitter::Query for Tags {
    ...
    fn raw(&self) -> &'static ::type_sitter::raw::Query {
        ...
        static __Tags__: std::sync::OnceLock<::type_sitter::raw::Query> =
            std::sync::OnceLock::new();
        __Tags__ . get_or_init (|| { # [allow (unused_mut)] let mut query = :: type_sitter :: raw :: Query :: new (& tree_sitter_python :: LANGUAGE . into () , "(module (expression_statement (assignment left: (identifier) @name) @definition.constant))\n\n(class_definition\n  name: (identifier) @name) @definition.class\n\n(function_definition\n  name: (identifier) @name) @definition.function\n\n(call\n  function: [\n      (identifier) @name\n      (attribute\n        attribute: (identifier) @name)\n  ]) @reference.call\n") . expect ("query parsed at compile-time but failed at runtime. Is the language 'tree_sitter_python' correct, and did you use the same tree-sitter / tree_sitter_python version?") ; query })
    }
    #[inline]
    unsafe fn wrap_match<'query, 'tree>(
        &self,
    ...
    unsafe fn wrap_capture<'query, 'tree: 'query>(
        ...
        match capture . index as usize { 0usize => TagsCapture :: Name (< super :: nodes :: Identifier < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , 1usize => TagsCapture :: DefinitionConstant (< super :: nodes :: Assignment < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , 2usize => TagsCapture :: DefinitionClass (< super :: nodes :: ClassDefinition < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , 3usize => TagsCapture :: DefinitionFunction (< super :: nodes :: FunctionDefinition < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , 4usize => TagsCapture :: ReferenceCall (< super :: nodes :: Call < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (capture . node)) , capture_index => unreachable ! ("Invalid capture index: {}" , capture_index) }
    }
}
#[automatically_derived]
#[allow(unused)]
impl<'query, 'tree: 'query> TagsMatch<'query, 'tree> {
    ...
    pub fn name(&self) -> super::nodes::Identifier<'tree> {
        let mut iterator = {
            [0u32] . into_iter () . flat_map (| i | self . 0 . nodes_for_capture_index (i)) . map (| n | unsafe { < super :: nodes :: Identifier < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (n) })
        };
    ...
    #[doc = "Returns an iterator over the nodes captured by `definition.constant` ([`super::nodes::Assignment`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(assignment left: (identifier) @name) @definition.constant"]
    #[doc = "```"]
    #[inline]
    pub fn definition_constant(&self) -> ::std::option::Option<super::nodes::Assignment<'tree>> {
        { [1u32] . into_iter () . flat_map (| i | self . 0 . nodes_for_capture_index (i)) . map (| n | unsafe { < super :: nodes :: Assignment < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (n) }) } . next ()
    }
    #[doc = "Returns an iterator over the nodes captured by `definition.class` ([`super::nodes::ClassDefinition`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(class_definition\n  name: (identifier) @name) @definition.class"]
    #[doc = "```"]
    #[inline]
    pub fn definition_class(&self) -> ::std::option::Option<super::nodes::ClassDefinition<'tree>> {
        { [2u32] . into_iter () . flat_map (| i | self . 0 . nodes_for_capture_index (i)) . map (| n | unsafe { < super :: nodes :: ClassDefinition < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (n) }) } . next ()
    }
    #[doc = "Returns an iterator over the nodes captured by `definition.function` ([`super::nodes::FunctionDefinition`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(function_definition\n  name: (identifier) @name) @definition.function"]
    ...
    pub fn definition_function(
        ...
        { [3u32] . into_iter () . flat_map (| i | self . 0 . nodes_for_capture_index (i)) . map (| n | unsafe { < super :: nodes :: FunctionDefinition < 'tree > as :: type_sitter :: Node < 'tree >> :: from_raw_unchecked (n) }) } . next ()
    }
    #[doc = "Returns an iterator over the nodes captured by `reference.call` ([`super::nodes::Call`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(call\n  function: [\n      (identifier) @name\n      (attribute\n        attribute: (identifier) @name)\n  ]) @reference.call"]
    ...
    pub fn reference_call(&self) -> ::std::option::Option<super::nodes::Call<'tree>> {
        {
            [4u32]
                ...
                .flat_map(|i| self.0.nodes_for_capture_index(i))
                .map(|n| unsafe {
                    <super::nodes::Call<'tree> as ::type_sitter::Node<'tree>>::from_raw_unchecked(n)
                })
        }
        .next()
    }
...
impl<'tree> TagsCapture<'tree> {
    ...
    #[doc = "Try to interpret this capture as a `definition.constant` ([`super::nodes::Assignment`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(assignment left: (identifier) @name) @definition.constant"]
    ...
    pub fn as_definition_constant(
        ...
        #[allow(irrefutable_let_patterns)]
        if let Self::DefinitionConstant(node) = self {
            Some(node)
        } else {
            None
        }
    }
    #[doc = "Try to interpret this capture as a `definition.class` ([`super::nodes::ClassDefinition`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(class_definition\n  name: (identifier) @name) @definition.class"]
    ...
    #[doc = "Try to interpret this capture as a `definition.function` ([`super::nodes::FunctionDefinition`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(function_definition\n  name: (identifier) @name) @definition.function"]
    ...
    #[doc = "Try to interpret this capture as a `reference.call` ([`super::nodes::Call`])"]
    #[doc = ""]
    #[doc = "The full capture including pattern(s) is:"]
    #[doc = "```sexp"]
    #[doc = "(call\n  function: [\n      (identifier) @name\n      (attribute\n        attribute: (identifier) @name)\n  ]) @reference.call"]
    #[doc = "```"]
    #[inline]
    pub fn as_reference_call(&self) -> ::std::option::Option<&super::nodes::Call<'tree>> {
        #[allow(irrefutable_let_patterns)]
...
impl<'query, 'tree: 'query> ::type_sitter::QueryCapture<'query, 'tree> for TagsCapture<'tree> {
    ...
    fn raw(&self) -> ::type_sitter::raw::QueryCapture<'tree> {
        ...
        match self {
            ...
            Self::DefinitionConstant(node) => ::type_sitter::raw::QueryCapture {
                index: 1usize as u32,
                node: *node.raw(),
            },
    ...
    fn node(&self) -> &::type_sitter::UntypedNode<'tree> {
        ...
        match self {
            ...
            Self::DefinitionConstant(node) => ::type_sitter::UntypedNode::r#ref(node.raw()),
    ...
    fn node_mut(&mut self) -> &mut ::type_sitter::UntypedNode<'tree> {
        ...
        match self {
            ...
            Self::DefinitionConstant(node) => ::type_sitter::UntypedNode::r#mut(node.raw_mut()),
...
pub mod anon_unions {
    ...
    #[doc = "One of `{decorator | identifier}`:\n- [`Decorator`]\n- [`Identifier`]"]
    #[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
    #[allow(non_camel_case_types)]
    ...
    impl<'tree> Function<'tree> {
        #[doc = "Returns the node if it is of type `decorator` ([`Decorator`]), otherwise returns `None`"]
        #[inline]
    ...
    impl<'tree> ::type_sitter::Node<'tree> for Function<'tree> {
        ...
        fn try_from_raw(
            ...
            if let Ok(this) = <Decorator<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node) {
                return Ok(Self::Decorator(this));
            }
        ...
        fn raw(&self) -> &::type_sitter::raw::Node<'tree> {
            match self {
                Self::Decorator(x) => ::type_sitter::Node::raw(x),
        ...
        fn raw_mut(&mut self) -> &mut ::type_sitter::raw::Node<'tree> {
            match self {
                Self::Decorator(x) => ::type_sitter::Node::raw_mut(x),
    ...
    #[doc = "One of `{as | assert | async | await | break | case | class | continue | def | del | elif | else | except | exec | finally | for | from | global | if | import | lambda | match | nonlocal | pass | print | raise | return | try | while | with | yield}`:\n- [`unnamed::As`]\n- [`unnamed::Assert`]\n- [`unnamed::Async`]\n- [`unnamed::Await`]\n- [`unnamed::Break`]\n- [`unnamed::Case`]\n- [`unnamed::Class`]\n- [`unnamed::Continue`]\n- [`unnamed::Def`]\n- [`unnamed::Del`]\n- [`unnamed::Elif`]\n- [`unnamed::Else`]\n- [`unnamed::Except`]\n- [`unnamed::Exec`]\n- [`unnamed::Finally`]\n- [`unnamed::For`]\n- [`unnamed::From`]\n- [`unnamed::Global`]\n- [`unnamed::If`]\n- [`unnamed::Import`]\n- [`unnamed::Lambda`]\n- [`unnamed::Match`]\n- [`unnamed::Nonlocal`]\n- [`unnamed::Pass`]\n- [`unnamed::Print`]\n- [`unnamed::Raise`]\n- [`unnamed::Return`]\n- [`unnamed::Try`]\n- [`unnamed::While`]\n- [`unnamed::With`]\n- [`unnamed::Yield`]"]
    #[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
    #[allow(non_camel_case_types)]
    ...
    impl<'tree> Keyword<'tree> {
        ...
        #[doc = "Returns the node if it is of type `assert` ([`unnamed::Assert`]), otherwise returns `None`"]
        #[inline]
        ...
        #[doc = "Returns the node if it is of type `case` ([`unnamed::Case`]), otherwise returns `None`"]
        #[inline]
        ...
        #[doc = "Returns the node if it is of type `class` ([`unnamed::Class`]), otherwise returns `None`"]
        #[inline]
        ...
        #[doc = "Returns the node if it is of type `def` ([`unnamed::Def`]), otherwise returns `None`"]
        #[inline]
        ...
        #[doc = "Returns the node if it is of type `del` ([`unnamed::Del`]), otherwise returns `None`"]
        #[inline]
        ...
        #[doc = "Returns the node if it is of type `elif` ([`unnamed::Elif`]), otherwise returns `None`"]
        #[inline]
        ...
        #[doc = "Returns the node if it is of type `except` ([`unnamed::Except`]), otherwise returns `None`"]
        #[inline]
        ...
        #[doc = "Returns the node if it is of type `exec` ([`unnamed::Exec`]), otherwise returns `None`"]
        #[inline]
        ...
        #[doc = "Returns the node if it is of type `finally` ([`unnamed::Finally`]), otherwise returns `None`"]
        #[inline]
        ...
        #[doc = "Returns the node if it is of type `from` ([`unnamed::From`]), otherwise returns `None`"]
        #[inline]
        ...
        #[doc = "Returns the node if it is of type `global` ([`unnamed::Global`]), otherwise returns `None`"]
        #[inline]
        ...
        #[doc = "Returns the node if it is of type `import` ([`unnamed::Import`]), otherwise returns `None`"]
        #[inline]
        ...
        #[doc = "Returns the node if it is of type `lambda` ([`unnamed::Lambda`]), otherwise returns `None`"]
        #[inline]
        ...
        #[doc = "Returns the node if it is of type `nonlocal` ([`unnamed::Nonlocal`]), otherwise returns `None`"]
        #[inline]
        ...
        #[doc = "Returns the node if it is of type `pass` ([`unnamed::Pass`]), otherwise returns `None`"]
        #[inline]
        ...
        #[doc = "Returns the node if it is of type `print` ([`unnamed::Print`]), otherwise returns `None`"]
        #[inline]
        ...
        #[doc = "Returns the node if it is of type `raise` ([`unnamed::Raise`]), otherwise returns `None`"]
        #[inline]
        ...
        #[doc = "Returns the node if it is of type `try` ([`unnamed::Try`]), otherwise returns `None`"]
        #[inline]
        ...
        #[doc = "Returns the node if it is of type `with` ([`unnamed::With`]), otherwise returns `None`"]
        #[inline]
    ...
    impl<'tree> ::type_sitter::Node<'tree> for Keyword<'tree> {
        ...
        fn try_from_raw(
            ...
            if let Ok(this) = <unnamed::As<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::As(this));
            }
            if let Ok(this) =
                <unnamed::Assert<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Assert(this));
            }
            if let Ok(this) =
                <unnamed::Async<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Async(this));
            }
            if let Ok(this) =
                <unnamed::Await<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Await(this));
            }
            if let Ok(this) =
                <unnamed::Break<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Break(this));
            }
            if let Ok(this) =
                <unnamed::Case<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Case(this));
            }
            if let Ok(this) =
                <unnamed::Class<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Class(this));
            }
            if let Ok(this) =
                <unnamed::Continue<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Continue(this));
            }
            if let Ok(this) =
                <unnamed::Def<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Def(this));
            }
            if let Ok(this) =
                <unnamed::Del<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Del(this));
            }
            if let Ok(this) =
                <unnamed::Elif<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Elif(this));
            }
            if let Ok(this) =
                <unnamed::Else<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Else(this));
            }
            if let Ok(this) =
                <unnamed::Except<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Except(this));
            }
            if let Ok(this) =
                <unnamed::Exec<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Exec(this));
            }
            if let Ok(this) =
                <unnamed::Finally<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Finally(this));
            }
            if let Ok(this) =
                <unnamed::For<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::For(this));
            }
            if let Ok(this) =
                <unnamed::From<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::From(this));
            }
            if let Ok(this) =
                <unnamed::Global<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Global(this));
            }
            if let Ok(this) = <unnamed::If<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::If(this));
            }
            if let Ok(this) =
                <unnamed::Import<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Import(this));
            }
            if let Ok(this) =
                <unnamed::Lambda<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Lambda(this));
            }
            if let Ok(this) =
                <unnamed::Match<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Match(this));
            }
            if let Ok(this) =
                <unnamed::Nonlocal<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Nonlocal(this));
            }
            if let Ok(this) =
                <unnamed::Pass<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Pass(this));
            }
            if let Ok(this) =
                <unnamed::Print<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Print(this));
            }
            if let Ok(this) =
                <unnamed::Raise<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Raise(this));
            }
            if let Ok(this) =
                <unnamed::Return<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Return(this));
            }
            if let Ok(this) =
                <unnamed::Try<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Try(this));
            }
            if let Ok(this) =
                <unnamed::While<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::While(this));
            }
            if let Ok(this) =
                <unnamed::With<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::With(this));
            }
            if let Ok(this) =
                <unnamed::Yield<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
        ...
        fn raw(&self) -> &::type_sitter::raw::Node<'tree> {
            match self {
                ...
                Self::Assert(x) => ::type_sitter::Node::raw(x),
                Self::Async(x) => ::type_sitter::Node::raw(x),
                Self::Await(x) => ::type_sitter::Node::raw(x),
                Self::Break(x) => ::type_sitter::Node::raw(x),
                Self::Case(x) => ::type_sitter::Node::raw(x),
                Self::Class(x) => ::type_sitter::Node::raw(x),
                Self::Continue(x) => ::type_sitter::Node::raw(x),
                Self::Def(x) => ::type_sitter::Node::raw(x),
                Self::Del(x) => ::type_sitter::Node::raw(x),
                Self::Elif(x) => ::type_sitter::Node::raw(x),
                Self::Else(x) => ::type_sitter::Node::raw(x),
                Self::Except(x) => ::type_sitter::Node::raw(x),
                Self::Exec(x) => ::type_sitter::Node::raw(x),
                Self::Finally(x) => ::type_sitter::Node::raw(x),
                Self::For(x) => ::type_sitter::Node::raw(x),
                Self::From(x) => ::type_sitter::Node::raw(x),
                Self::Global(x) => ::type_sitter::Node::raw(x),
                Self::If(x) => ::type_sitter::Node::raw(x),
                Self::Import(x) => ::type_sitter::Node::raw(x),
                Self::Lambda(x) => ::type_sitter::Node::raw(x),
                Self::Match(x) => ::type_sitter::Node::raw(x),
                Self::Nonlocal(x) => ::type_sitter::Node::raw(x),
                Self::Pass(x) => ::type_sitter::Node::raw(x),
                Self::Print(x) => ::type_sitter::Node::raw(x),
                Self::Raise(x) => ::type_sitter::Node::raw(x),
                Self::Return(x) => ::type_sitter::Node::raw(x),
                Self::Try(x) => ::type_sitter::Node::raw(x),
                Self::While(x) => ::type_sitter::Node::raw(x),
                Self::With(x) => ::type_sitter::Node::raw(x),
        ...
        fn raw_mut(&mut self) -> &mut ::type_sitter::raw::Node<'tree> {
            match self {
                ...
                Self::Assert(x) => ::type_sitter::Node::raw_mut(x),
                Self::Async(x) => ::type_sitter::Node::raw_mut(x),
                Self::Await(x) => ::type_sitter::Node::raw_mut(x),
                Self::Break(x) => ::type_sitter::Node::raw_mut(x),
                Self::Case(x) => ::type_sitter::Node::raw_mut(x),
                Self::Class(x) => ::type_sitter::Node::raw_mut(x),
                Self::Continue(x) => ::type_sitter::Node::raw_mut(x),
                Self::Def(x) => ::type_sitter::Node::raw_mut(x),
                Self::Del(x) => ::type_sitter::Node::raw_mut(x),
                Self::Elif(x) => ::type_sitter::Node::raw_mut(x),
                Self::Else(x) => ::type_sitter::Node::raw_mut(x),
                Self::Except(x) => ::type_sitter::Node::raw_mut(x),
                Self::Exec(x) => ::type_sitter::Node::raw_mut(x),
                Self::Finally(x) => ::type_sitter::Node::raw_mut(x),
                Self::For(x) => ::type_sitter::Node::raw_mut(x),
                Self::From(x) => ::type_sitter::Node::raw_mut(x),
                Self::Global(x) => ::type_sitter::Node::raw_mut(x),
                Self::If(x) => ::type_sitter::Node::raw_mut(x),
                Self::Import(x) => ::type_sitter::Node::raw_mut(x),
                Self::Lambda(x) => ::type_sitter::Node::raw_mut(x),
                Self::Match(x) => ::type_sitter::Node::raw_mut(x),
                Self::Nonlocal(x) => ::type_sitter::Node::raw_mut(x),
                Self::Pass(x) => ::type_sitter::Node::raw_mut(x),
                Self::Print(x) => ::type_sitter::Node::raw_mut(x),
                Self::Raise(x) => ::type_sitter::Node::raw_mut(x),
                Self::Return(x) => ::type_sitter::Node::raw_mut(x),
                Self::Try(x) => ::type_sitter::Node::raw_mut(x),
                Self::While(x) => ::type_sitter::Node::raw_mut(x),
                Self::With(x) => ::type_sitter::Node::raw_mut(x),
    ...
    #[doc = "One of `{!= | % | %= | & | &= | * | ** | **= | *= | + | += | - | -= | -> | / | // | //= | /= | := | < | << | <<= | <= | <> | = | == | > | >= | >> | >>= | @= | ^ | ^= | and | in | is | is not | not | not in | or | | | |= | ~}`:\n- [`symbols::NotEq`]\n- [`symbols::Mod`]\n- [`symbols::ModEq`]\n- [`symbols::And`]\n- [`symbols::AndEq`]\n- [`symbols::Mul`]\n- [`symbols::MulMul`]\n- [`symbols::MulMulEq`]\n- [`symbols::MulEq`]\n- [`symbols::Add`]\n- [`symbols::AddEq`]\n- [`symbols::Sub`]\n- [`symbols::SubEq`]\n- [`symbols::SubGt`]\n- [`symbols::Div`]\n- [`symbols::DivDiv`]\n- [`symbols::DivDivEq`]\n- [`symbols::DivEq`]\n- [`symbols::ColonEq`]\n- [`symbols::Lt`]\n- [`symbols::LtLt`]\n- [`symbols::LtLtEq`]\n- [`symbols::LtEq`]\n- [`symbols::LtGt`]\n- [`symbols::Eq`]\n- [`symbols::EqEq`]\n- [`symbols::Gt`]\n- [`symbols::GtEq`]\n- [`symbols::GtGt`]\n- [`symbols::GtGtEq`]\n- [`symbols::AtEq`]\n- [`symbols::BitXor`]\n- [`symbols::BitXorEq`]\n- [`unnamed::And`]\n- [`unnamed::In`]\n- [`unnamed::Is`]\n- [`symbols::IsSpacenot`]\n- [`unnamed::Not`]\n- [`symbols::NotSpacein`]\n- [`unnamed::Or`]\n- [`symbols::Or`]\n- [`symbols::OrEq`]\n- [`symbols::BitNot`]"]
    #[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
    #[allow(non_camel_case_types)]
    ...
    impl<'tree> Operator<'tree> {
        ...
        #[doc = "Returns the node if it is of type `->` ([`symbols::SubGt`]), otherwise returns `None`"]
        #[inline]
        ...
        #[doc = "Returns the node if it is of type `:=` ([`symbols::ColonEq`]), otherwise returns `None`"]
        #[inline]
        ...
        #[doc = "Returns the node if it is of type `=` ([`symbols::Eq`]), otherwise returns `None`"]
        #[inline]
    ...
    impl<'tree> ::type_sitter::Node<'tree> for Operator<'tree> {
        ...
        fn try_from_raw(
            ...
            if let Ok(this) =
                <symbols::SubGt<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
            ...
            if let Ok(this) =
                <symbols::ColonEq<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::ColonEq(this));
            }
            ...
            if let Ok(this) = <symbols::Eq<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
            ...
            if let Ok(this) =
                <unnamed::Not<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::Not(this));
            }
            if let Ok(this) =
        ...
        fn raw(&self) -> &::type_sitter::raw::Node<'tree> {
            match self {
                ...
                Self::ColonEq(x) => ::type_sitter::Node::raw(x),
                ...
                Self::Eq(x) => ::type_sitter::Node::raw(x),
        ...
        fn raw_mut(&mut self) -> &mut ::type_sitter::raw::Node<'tree> {
            match self {
                ...
                Self::ColonEq(x) => ::type_sitter::Node::raw_mut(x),
                ...
                Self::Eq(x) => ::type_sitter::Node::raw_mut(x),
    ...
    #[automatically_derived]
    impl<'tree> ::type_sitter::Node<'tree> for PunctuationSpecial<'tree> {
        ...
        fn try_from_raw(
            ...
            if let Ok(this) =
                <symbols::LBrace<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::LBrace(this));
            }
            if let Ok(this) =
                <symbols::RBrace<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node)
            {
                return Ok(Self::RBrace(this));
            }
            Err(::type_sitter::IncorrectKind::new::<Self>(node))
        }
        #[inline]
