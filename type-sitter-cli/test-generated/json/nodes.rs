...
impl<'tree> ::type_sitter::Node<'tree> for Value<'tree> {
    ...
    fn try_from_raw(
        ...
        if let Ok(this) = <Array<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node) {
            return Ok(Self::Array(this));
        }
        ...
        if let Ok(this) = <Number<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node) {
            return Ok(Self::Number(this));
        }
        if let Ok(this) = <Object<'tree> as ::type_sitter::Node<'tree>>::try_from_raw(node) {
            return Ok(Self::Object(this));
        }
