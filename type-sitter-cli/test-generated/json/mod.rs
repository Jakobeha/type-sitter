...
impl<'tree> Value<'tree> {
    # [doc = concat ! ("Returns the node if it is of kind `" , "array" , "`, otherwise returns None")]
    #[inline]
    ...
    # [doc = concat ! ("Returns the node if it is of kind `" , "false" , "`, otherwise returns None")]
    #[inline]
    #[allow(unused, non_snake_case)]
    ...
    # [doc = concat ! ("Returns the node if it is of kind `" , "null" , "`, otherwise returns None")]
    #[inline]
    #[allow(unused, non_snake_case)]
    ...
    # [doc = concat ! ("Returns the node if it is of kind `" , "number" , "`, otherwise returns None")]
    #[inline]
    #[allow(unused, non_snake_case)]
    ...
    # [doc = concat ! ("Returns the node if it is of kind `" , "object" , "`, otherwise returns None")]
    #[inline]
    #[allow(unused, non_snake_case)]
    ...
    # [doc = concat ! ("Returns the node if it is of kind `" , "string" , "`, otherwise returns None")]
    #[inline]
    #[allow(unused, non_snake_case)]
    ...
    # [doc = concat ! ("Returns the node if it is of kind `" , "true" , "`, otherwise returns None")]
    #[inline]
    #[allow(unused, non_snake_case)]
...
impl<'tree> Pair<'tree> {
    ...
    pub fn key(&self) -> type_sitter_lib::NodeResult<'tree, anon_unions::Number_String> {
        self . 0 . child_by_field_name ("key") . map (< anon_unions :: Number_String as TryFrom < _ >> :: try_from) . expect ("tree-sitter node missing its required child, there should at least be a MISSING node in its place")
    }
...
pub mod anon_unions {
    ...
    #[automatically_derived]
    impl<'tree> TryFrom<tree_sitter::Node<'tree>> for Number_String<'tree> {
        type Error = type_sitter_lib::IncorrectKind<'tree>;
        #[inline]
        fn try_from(node: tree_sitter::Node<'tree>) -> Result<Self, Self::Error> {
            match node.kind() {
