...
HighlightsMatch { r#match: QueryMatch { id: 1, pattern_index: 47, captures: [QueryCapture { node: {Node fn (1, 0) - (1, 2)}, index: 13 }] } }
HighlightsMatch { r#match: QueryMatch { id: 2, pattern_index: 14, captures: [QueryCapture { node: {Node identifier (1, 3) - (1, 7)}, index: 3 }] } }
HighlightsMatch { r#match: QueryMatch { id: 5, pattern_index: 21, captures: [QueryCapture { node: {Node ( (1, 7) - (1, 8)}, index: 9 }] } }
HighlightsMatch { r#match: QueryMatch { id: 6, pattern_index: 22, captures: [QueryCapture { node: {Node ) (1, 8) - (1, 9)}, index: 9 }] } }
HighlightsMatch { r#match: QueryMatch { id: 7, pattern_index: 25, captures: [QueryCapture { node: {Node { (1, 10) - (1, 11)}, index: 9 }] } }
HighlightsMatch { r#match: QueryMatch { id: 8, pattern_index: 52, captures: [QueryCapture { node: {Node let (2, 4) - (2, 7)}, index: 13 }] } }
HighlightsMatch { r#match: QueryMatch { id: 11, pattern_index: 78, captures: [QueryCapture { node: {Node string_literal (2, 15) - (5, 6)}, index: 15 }] } }
HighlightsMatch { r#match: QueryMatch { id: 12, pattern_index: 83, captures: [QueryCapture { node: {Node escape_sequence (3, 8) - (3, 10)}, index: 17 }] } }
HighlightsMatch { r#match: QueryMatch { id: 13, pattern_index: 83, captures: [QueryCapture { node: {Node escape_sequence (3, 14) - (3, 16)}, index: 17 }] } }
HighlightsMatch { r#match: QueryMatch { id: 14, pattern_index: 83, captures: [QueryCapture { node: {Node escape_sequence (3, 18) - (3, 20)}, index: 17 }] } }
HighlightsMatch { r#match: QueryMatch { id: 15, pattern_index: 83, captures: [QueryCapture { node: {Node escape_sequence (3, 25) - (3, 27)}, index: 17 }] } }
HighlightsMatch { r#match: QueryMatch { id: 16, pattern_index: 83, captures: [QueryCapture { node: {Node escape_sequence (4, 8) - (4, 10)}, index: 17 }] } }
HighlightsMatch { r#match: QueryMatch { id: 17, pattern_index: 83, captures: [QueryCapture { node: {Node escape_sequence (4, 17) - (4, 19)}, index: 17 }] } }
HighlightsMatch { r#match: QueryMatch { id: 18, pattern_index: 83, captures: [QueryCapture { node: {Node escape_sequence (4, 21) - (4, 23)}, index: 17 }] } }
HighlightsMatch { r#match: QueryMatch { id: 19, pattern_index: 83, captures: [QueryCapture { node: {Node escape_sequence (4, 28) - (4, 30)}, index: 17 }] } }
HighlightsMatch { r#match: QueryMatch { id: 20, pattern_index: 33, captures: [QueryCapture { node: {Node ; (5, 6) - (5, 7)}, index: 10 }] } }
HighlightsMatch { r#match: QueryMatch { id: 21, pattern_index: 52, captures: [QueryCapture { node: {Node let (6, 4) - (6, 7)}, index: 13 }] } }
HighlightsMatch { r#match: QueryMatch { id: 22, pattern_index: 71, captures: [QueryCapture { node: {Node mutable_specifier (6, 8) - (6, 11)}, index: 13 }] } }
HighlightsMatch { r#match: QueryMatch { id: 28, pattern_index: 29, captures: [QueryCapture { node: {Node :: (6, 32) - (6, 34)}, index: 10 }] } }
HighlightsMatch { r#match: QueryMatch { id: 29, pattern_index: 2, captures: [QueryCapture { node: {Node identifier (6, 34) - (6, 40)}, index: 1 }] } }
HighlightsMatch { r#match: QueryMatch { id: 31, pattern_index: 5, captures: [QueryCapture { node: {Node identifier (6, 34) - (6, 40)}, index: 2 }] } }
HighlightsMatch { r#match: QueryMatch { id: 32, pattern_index: 29, captures: [QueryCapture { node: {Node :: (6, 40) - (6, 42)}, index: 10 }] } }
HighlightsMatch { r#match: QueryMatch { id: 33, pattern_index: 9, captures: [QueryCapture { node: {Node identifier (6, 42) - (6, 45)}, index: 3 }] } }
HighlightsMatch { r#match: QueryMatch { id: 36, pattern_index: 21, captures: [QueryCapture { node: {Node ( (6, 45) - (6, 46)}, index: 9 }] } }
HighlightsMatch { r#match: QueryMatch { id: 37, pattern_index: 22, captures: [QueryCapture { node: {Node ) (6, 46) - (6, 47)}, index: 9 }] } }
HighlightsMatch { r#match: QueryMatch { id: 38, pattern_index: 33, captures: [QueryCapture { node: {Node ; (6, 47) - (6, 48)}, index: 10 }] } }
HighlightsMatch { r#match: QueryMatch { id: 41, pattern_index: 13, captures: [QueryCapture { node: {Node identifier (7, 4) - (7, 8)}, index: 5 }, QueryCapture { node: {Node ! (7, 8) - (7, 9)}, index: 5 }] } }
HighlightsMatch { r#match: QueryMatch { id: 42, pattern_index: 21, captures: [QueryCapture { node: {Node ( (7, 9) - (7, 10)}, index: 9 }] } }
HighlightsMatch { r#match: QueryMatch { id: 43, pattern_index: 78, captures: [QueryCapture { node: {Node string_literal (7, 10) - (7, 15)}, index: 15 }] } }
HighlightsMatch { r#match: QueryMatch { id: 44, pattern_index: 22, captures: [QueryCapture { node: {Node ) (7, 15) - (7, 16)}, index: 9 }] } }
HighlightsMatch { r#match: QueryMatch { id: 45, pattern_index: 26, captures: [QueryCapture { node: {Node } (8, 0) - (8, 1)}, index: 9 }] } }
"#[1..]);
    let captures_str = q
